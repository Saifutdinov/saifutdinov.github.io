...
- **Инструменты**: bash, nginx, apache, elasticsearch, RabbitMQ/Kafka, exim, PDF References, certbot+letsencrypt, postman, swagger
...
- тестировал новые фичи проекта и исследова баги
